...
|Apr 28     |  Project status updates. Software design (Guest, 1 hr). Student in-class development of use cases (All, 1 hr). Python package structure and packaging (1.5 hr).      | [Overview of Software Design](https://en.wikipedia.org/wiki/Software_design) | Homework 2 due. |
