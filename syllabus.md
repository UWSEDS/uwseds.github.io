...
|May 5     | Introduction to objects and OO design (J, 1.5 hr). Geospatial data science (Tony, 2 hr). Technology review example (All, 0.5 hr).  (See [folder](https://github.com/UWSEDS/LectureNotes/tree/master/week_6) with slides & notebooks.)|  | [Homework 3](https://classroom.github.com/a/ERyE21uo) due. |
