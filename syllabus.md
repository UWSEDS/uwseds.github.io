...
| HW1 due.<br>[HW2](https://classroom.github.com/a/HiNYVALV) assigned. | **October 20**:<br>Project overview, More git (if needed) or Python imports and modules (Bernease) | | **October 22**:<br>Programming style & documentation (Dave) | | [Projects](http://uwseds.github.io/projects.html) |
| HW3 assigned. | **October 27**:<br>Student project proposals, team formation (All) | HW2 due. | **October 29**:<br>Debugging, exceptions, testing (Bernease) | | |
